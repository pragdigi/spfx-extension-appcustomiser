 ...
 */
export interface ITestAppCustomiserApplicationCustomizerProperties {
...
export default class TestAppCustomiserApplicationCustomizer extends BaseApplicationCustomizer<
  ITestAppCustomiserApplicationCustomizerProperties
> {
